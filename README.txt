...
Available commands
1. Show log metrics                   : Export log metrics, within a date interval, to a CSV file.
2. Export all Unified Audit Logs      : Export all available Unified Audit Logs, within a date interval.
3. Export group Unified Audit Logs    : Export a group of Unified Audit Logs, within a date interval (e. g., all Exchange, OneDrive or SharePoint logs).
4. Export specific Unified Audit Logs : Export a subset of the Unified Audit Logs. The tool needs to be configured with the required AuditLogRecordType. The full list can be found at: https://docs.microsoft.com/en-us/office/office-365-management-api/office-365-management-activity-api-schema#enum-auditlogrecordtype---type-edmint32
